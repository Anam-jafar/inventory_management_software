...
<div class="row">
    ...
    <div class="card">
        ...
        <p class="card-description"> Enter necessary information in the form below to add a new customer. </p>
        <form class="forms-sample" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="number" class="form-control" id="contact" placeholder="Enter total invoiced amount " name="total_invoiced_amount">
                </div>
                <label for="nid" class="col-sm-3 col-form-label">Due</label>
                <div class="col-sm-3">
                    <input type="number" class="form-control" id="nid" placeholder="Enter total due" name="due">
                </div>
            </div>
