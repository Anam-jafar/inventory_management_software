    ...
    <div class="card">
        ...
        <form class="forms-sample" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="contact" placeholder="Enter total invoiced amount " name="total_invoiced_amount">
                </div>
                <label for="nid" class="col-sm-3 col-form-label">Due</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="nid" placeholder="Enter total due" name="due">
                </div>
            </div>
