...
<div class="row">
    ...
    <div class="card">
        ...
        <p class="card-description"> Enter necessary information in the form below to update employee information. </p>
        <form class="forms-sample" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="date" class="form-control" id="joined_date" name="joined_at" value="{{$employee->joined_at}}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="contact" value="{{$employee->contact}}" name="contact">
                </div>
                <label for="nid" class="col-sm-3 col-form-label">NID</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="nid" value="{{$employee->nid}}" name="nid">
                </div>
            </div>
            <div class="form-group row">
